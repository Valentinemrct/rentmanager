                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="client_id" name="client_id" placeholder="ClientId">
                                    </div>
                                    
                                
                                 <div class="form-group">
                                    <label for="vehicle_id" class="col-sm-2 control-label">VehicleId</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="vehicle_id" name="vehicle_id" placeholder="VehicleId">
                                    </div>
                                </div>
