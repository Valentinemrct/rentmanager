        ...
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/rents/create">Ajouter</a>
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/rents/delete">Supprimer</a>
                                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/rents/edit">Modifier</a>
