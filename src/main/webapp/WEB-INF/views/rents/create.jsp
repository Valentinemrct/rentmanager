                        ...
                        <form class="form-horizontal" method="post" >
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="car" class="col-sm-2 control-label">Vehicle ID</label>

                                    <div class="col-sm-10">
                                        <select class="form-control" id="car" name="vehicle_id">
                                ...
                                <div class="form-group">
                                    <label for="client" class="col-sm-2 control-label">Client ID</label>
