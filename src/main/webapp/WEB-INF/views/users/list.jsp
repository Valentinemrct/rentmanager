        ...
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/users/create">Ajouter</a>
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/users/delete">Supprimer</a>
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/users/edit">Editer</a>
